...
```mermaid
    graph LR
        ...
        modules.models._base.dataset._datasetInfo_DatasetInfo("DatasetInfo(modules.models._base.dataset._datasetInfo)") --> modules.models._prediction.dataset._datasetManager_PredictionDatasetInfo("PredictionDatasetInfo(modules.models._prediction.dataset._datasetManager)")
        ...
        modules.models._prediction.structure_Structure("Structure(modules.models._prediction.structure)") --> modules.Vertical._VirisAlphaG_VIrisAlphaG("VIrisAlphaG(modules.Vertical._VirisAlphaG)")
